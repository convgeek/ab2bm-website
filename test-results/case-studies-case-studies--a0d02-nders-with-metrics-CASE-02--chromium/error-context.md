...
- Name: case-studies.spec.ts >> case studies >> individual case study page renders with metrics (CASE-02)
- Location: tests/e2e/case-studies.spec.ts:16:7
...
Call log:
  - waiting for locator('[data-testid="case-study-card"] a').first()
