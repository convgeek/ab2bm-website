...
- Name: homepage.spec.ts >> logo strip >> logo strip renders below hero (TRST-01)
...
Locator: locator('[data-testid="logo-strip"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="logo-strip"]')
