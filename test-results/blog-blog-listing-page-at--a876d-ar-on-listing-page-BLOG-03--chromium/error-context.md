...
- Name: blog.spec.ts >> blog listing page >> at least 6 posts appear on listing page (BLOG-03)
...
Locator:  locator('[data-testid="blog-card"]')
Expected: 6
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="blog-card"]')
