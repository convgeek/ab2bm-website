...
- Name: homepage.spec.ts >> programs overview >> programs overview section renders with CTAs
...
Locator: locator('[data-testid="programs-overview"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="programs-overview"]')
