...
- Name: homepage.spec.ts >> social proof >> social proof / testimonial section renders (TRST-03)
- Location: tests/e2e/homepage.spec.ts:42:7
...
Locator: locator('[data-testid="testimonial-highlight"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="testimonial-highlight"]')
