...
- Name: homepage.spec.ts >> audience stats >> audience stats section renders
- Location: tests/e2e/homepage.spec.ts:35:7
...
Locator: locator('[data-testid="audience-stats"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="audience-stats"]')
